...
* [Extension.js](https://github.com/cezaraugusto/extension.js) ⭐ 5,139 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-04 - Plug-and-play, zero-config, cross-browser extension development tool.
...
* [addons-linter](https://github.com/mozilla/addons-linter) ⭐ 363 | 🐛 73 | 🌐 JavaScript | 📅 2026-09-04 - Validate an extension against Mozilla's guidelines.
...
* [mdn/webextension-examples](https://github.com/mdn/webextensions-examples) ⭐ 4,471 | 🐛 30 | 🌐 JavaScript | 📅 2026-09-03 - Various example extensions curated for the MDN documentation.
