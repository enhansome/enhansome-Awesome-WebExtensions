...
* [Extension.js](https://github.com/cezaraugusto/extension.js) ⭐ 5,153 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-11 - Plug-and-play, zero-config, cross-browser extension development tool.
* [mozilla/web-ext](https://github.com/mozilla/web-ext) ⭐ 3,134 | 🐛 217 | 🌐 JavaScript | 📅 2026-09-11 - Command line tool to help build, run, and test WebExtensions.
...
* [addons-linter](https://github.com/mozilla/addons-linter) ⭐ 363 | 🐛 63 | 🌐 JavaScript | 📅 2026-09-11 - Validate an extension against Mozilla's guidelines.
...
* [WXT](https://github.com/wxt-dev/wxt) ⭐ 10,479 | 🐛 211 | 🌐 TypeScript | 📅 2026-09-07 - Next-gen framework for developing web extensions
