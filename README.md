...
* [Extension.js](https://github.com/cezaraugusto/extension.js) ⭐ 5,147 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-07 - Plug-and-play, zero-config, cross-browser extension development tool.
* [mozilla/web-ext](https://github.com/mozilla/web-ext) ⭐ 3,134 | 🐛 227 | 🌐 JavaScript | 📅 2026-09-07 - Command line tool to help build, run, and test WebExtensions.
...
* [addons-linter](https://github.com/mozilla/addons-linter) ⭐ 363 | 🐛 74 | 🌐 JavaScript | 📅 2026-09-08 - Validate an extension against Mozilla's guidelines.
...
* [WXT](https://github.com/wxt-dev/wxt) ⭐ 10,465 | 🐛 208 | 🌐 TypeScript | 📅 2026-09-07 - Next-gen framework for developing web extensions
...
* [mdn/webextension-examples](https://github.com/mdn/webextensions-examples) ⭐ 4,472 | 🐛 30 | 🌐 JavaScript | 📅 2026-09-08 - Various example extensions curated for the MDN documentation.
