...
* [Extension.js](https://github.com/cezaraugusto/extension.js) ⭐ 5,138 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-31 - Plug-and-play, zero-config, cross-browser extension development tool.
...
* [addons-linter](https://github.com/mozilla/addons-linter) ⭐ 362 | 🐛 73 | 🌐 JavaScript | 📅 2026-09-04 - Validate an extension against Mozilla's guidelines.
...
* [WXT](https://github.com/wxt-dev/wxt) ⭐ 10,452 | 🐛 203 | 🌐 TypeScript | 📅 2026-09-02 - Next-gen framework for developing web extensions
...
* [mdn/webextension-examples](https://github.com/mdn/webextensions-examples) ⭐ 4,472 | 🐛 30 | 🌐 JavaScript | 📅 2026-09-03 - Various example extensions curated for the MDN documentation.
