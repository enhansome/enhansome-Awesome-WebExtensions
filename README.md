...
* [Extension.js](https://github.com/cezaraugusto/extension.js) ⭐ 5,145 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-07 - Plug-and-play, zero-config, cross-browser extension development tool.
...
* [addons-linter](https://github.com/mozilla/addons-linter) ⭐ 363 | 🐛 73 | 🌐 JavaScript | 📅 2026-09-07 - Validate an extension against Mozilla's guidelines.
...
* [WXT](https://github.com/wxt-dev/wxt) ⭐ 10,460 | 🐛 206 | 🌐 TypeScript | 📅 2026-09-06 - Next-gen framework for developing web extensions
...
* [mdn/webextension-examples](https://github.com/mdn/webextensions-examples) ⭐ 4,472 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-07 - Various example extensions curated for the MDN documentation.
