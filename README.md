...
* [Extension.js](https://github.com/cezaraugusto/extension.js) ⭐ 5,061 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-09 - Plug-and-play, zero-config, cross-browser extension development tool.
* [mozilla/web-ext](https://github.com/mozilla/web-ext) ⭐ 3,124 | 🐛 223 | 🌐 JavaScript | 📅 2026-08-12 - Command line tool to help build, run, and test WebExtensions.
...
* [addons-linter](https://github.com/mozilla/addons-linter) ⭐ 363 | 🐛 67 | 🌐 JavaScript | 📅 2026-08-12 - Validate an extension against Mozilla's guidelines.
...
* [WXT](https://github.com/wxt-dev/wxt) ⭐ 10,339 | 🐛 189 | 🌐 TypeScript | 📅 2026-08-12 - Next-gen framework for developing web extensions
...
* [mdn/webextension-examples](https://github.com/mdn/webextensions-examples) ⭐ 4,467 | 🐛 32 | 🌐 JavaScript | 📅 2026-07-30 - Various example extensions curated for the MDN documentation.
