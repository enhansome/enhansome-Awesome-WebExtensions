...
* [ExtPay](https://github.com/Glench/ExtPay) ⭐ 764 | 🐛 11 | 🌐 JavaScript | 📅 2026-07-18 - Take secure payments in extensions without needing to run a server backend.
...
* [webext-dynamic-content-scripts](https://github.com/fregante/webext-dynamic-content-scripts) ⭐ 92 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-30 - Automatically inject your `content_scripts` on custom domains.
...
* [Extension.js](https://github.com/cezaraugusto/extension.js) ⭐ 5,071 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-29 - Plug-and-play, zero-config, cross-browser extension development tool.
* [mozilla/web-ext](https://github.com/mozilla/web-ext) ⭐ 3,133 | 🐛 226 | 🌐 JavaScript | 📅 2026-08-24 - Command line tool to help build, run, and test WebExtensions.
...
* [addons-linter](https://github.com/mozilla/addons-linter) ⭐ 363 | 🐛 69 | 🌐 JavaScript | 📅 2026-08-28 - Validate an extension against Mozilla's guidelines.
...
* [WXT](https://github.com/wxt-dev/wxt) ⭐ 10,428 | 🐛 200 | 🌐 TypeScript | 📅 2026-08-22 - Next-gen framework for developing web extensions
...
* [generator-web-extension](https://github.com/webextension-toolbox/generator-web-extension) ⭐ 318 | 🐛 13 | 🌐 JavaScript | 📅 2023-03-01 - WebExtension generator that creates everything you need to get started with cross-browser web-extension development.
...
* [mdn/webextension-examples](https://github.com/mdn/webextensions-examples) ⭐ 4,472 | 🐛 32 | 🌐 JavaScript | 📅 2026-07-30 - Various example extensions curated for the MDN documentation.
