...
* [ExtPay](https://github.com/Glench/ExtPay) ⭐ 766 | 🐛 11 | 🌐 JavaScript | 📅 2026-07-18 - Take secure payments in extensions without needing to run a server backend.
...
* [Extension.js](https://github.com/extension-js/extension.js) ⭐ 5,159 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-17 - Zero-config CLI to develop, build and package extensions for Chrome, Edge, Firefox and Safari.
* [mozilla/web-ext](https://github.com/mozilla/web-ext) ⭐ 3,138 | 🐛 223 | 🌐 JavaScript | 📅 2026-09-17 - Command line tool to help build, run, and test WebExtensions.
...
* [addons-linter](https://github.com/mozilla/addons-linter) ⭐ 362 | 🐛 62 | 🌐 JavaScript | 📅 2026-09-17 - Validate an extension against Mozilla's guidelines.
...
* [WXT](https://github.com/wxt-dev/wxt) ⭐ 10,516 | 🐛 215 | 🌐 TypeScript | 📅 2026-09-16 - Next-gen framework for developing web extensions.
