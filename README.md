...
* [Extension.js](https://github.com/cezaraugusto/extension.js) ⭐ 5,157 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-14 - Plug-and-play, zero-config, cross-browser extension development tool.
* [mozilla/web-ext](https://github.com/mozilla/web-ext) ⭐ 3,135 | 🐛 223 | 🌐 JavaScript | 📅 2026-09-14 - Command line tool to help build, run, and test WebExtensions.
...
* [addons-linter](https://github.com/mozilla/addons-linter) ⭐ 363 | 🐛 64 | 🌐 JavaScript | 📅 2026-09-14 - Validate an extension against Mozilla's guidelines.
...
* [WXT](https://github.com/wxt-dev/wxt) ⭐ 10,496 | 🐛 214 | 🌐 TypeScript | 📅 2026-09-12 - Next-gen framework for developing web extensions
