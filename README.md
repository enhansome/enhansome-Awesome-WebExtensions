...
* [Extension.js](https://github.com/cezaraugusto/extension.js) ⭐ 5,150 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-10 - Plug-and-play, zero-config, cross-browser extension development tool.
* [mozilla/web-ext](https://github.com/mozilla/web-ext) ⭐ 3,134 | 🐛 217 | 🌐 JavaScript | 📅 2026-09-10 - Command line tool to help build, run, and test WebExtensions.
* [Chrome extension source viewer](https://github.com/Rob--W/crxviewer) ⭐ 1,715 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-01 - WebExtension to view source code of extensions directly on the store.
...
* [addons-linter](https://github.com/mozilla/addons-linter) ⭐ 363 | 🐛 64 | 🌐 JavaScript | 📅 2026-09-10 - Validate an extension against Mozilla's guidelines.
...
* [WXT](https://github.com/wxt-dev/wxt) ⭐ 10,476 | 🐛 211 | 🌐 TypeScript | 📅 2026-09-07 - Next-gen framework for developing web extensions
...
* [mdn/webextension-examples](https://github.com/mdn/webextensions-examples) ⭐ 4,472 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-08 - Various example extensions curated for the MDN documentation.
