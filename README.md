...
* [ExtPay](https://github.com/Glench/ExtPay) ⭐ 769 | 🐛 10 | 🌐 JavaScript | 📅 2026-07-18 - Take secure payments in extensions without needing to run a server backend.
...
* [Extension.js](https://github.com/extension-js/extension.js) ⭐ 5,170 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-21 - Zero-config CLI to develop, build and package extensions for Chrome, Edge, Firefox and Safari.
* [mozilla/web-ext](https://github.com/mozilla/web-ext) ⭐ 3,137 | 🐛 223 | 🌐 JavaScript | 📅 2026-09-22 - Command line tool to help build, run, and test WebExtensions.
...
* [addons-linter](https://github.com/mozilla/addons-linter) ⭐ 362 | 🐛 62 | 🌐 JavaScript | 📅 2026-09-22 - Validate an extension against Mozilla's guidelines.
...
* [WXT](https://github.com/wxt-dev/wxt) ⭐ 10,530 | 🐛 219 | 🌐 TypeScript | 📅 2026-09-18 - Next-gen framework for developing web extensions.
...
* [mdn/webextension-examples](https://github.com/mdn/webextensions-examples) ⭐ 4,476 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-22 - Various example extensions curated for the MDN documentation.
