...
* [Extension.js](https://github.com/cezaraugusto/extension.js) ⭐ 5,143 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-06 - Plug-and-play, zero-config, cross-browser extension development tool.
* [mozilla/web-ext](https://github.com/mozilla/web-ext) ⭐ 3,133 | 🐛 227 | 🌐 JavaScript | 📅 2026-09-03 - Command line tool to help build, run, and test WebExtensions.
...
* [WXT](https://github.com/wxt-dev/wxt) ⭐ 10,453 | 🐛 205 | 🌐 TypeScript | 📅 2026-09-06 - Next-gen framework for developing web extensions
...
* [mdn/webextension-examples](https://github.com/mdn/webextensions-examples) ⭐ 4,472 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-03 - Various example extensions curated for the MDN documentation.
